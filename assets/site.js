  ...
  window.NavigationView = (function(superClass) {
    ...
    NavigationView.prototype.toggleNavigation = function(e) {
      ...
      if (target.parent().hasClass('has-dropdown')) {
        ...
        if(target.parents('.header-drawer').length == 0){
...
(function() {
  ...
  window.HeaderView = (function(superClass) {
    ...
    HeaderView.prototype.fitHeader = function() {
      ...
      if(headerWidth < 870){ 
        $('body:not(.coll-nav)').addClass('coll-nav');
      }else{
        $('body.coll-nav').removeClass('coll-nav');
      }
      $('.main-header-wrapper:not(.faded)').css('opacity','1').addClass('faded');
      return this.mainHeader.toggleClass('collapsed-navigation', this.combinedWidth + 65 > headerWidth);
    };
...
(function() {
  ...
  window.ProductView = (function(superClass) {
    ...
    ProductView.prototype.initialize = function() {
      ...
      this.secondSlideshow = this.$(".home-slideshow");
      ...
      if (this.secondSlideshow.length) {
        new SlideshowView({
          el: this.$(".second-slideshow-wrapper")
        });
      }
    ...
    ProductView.prototype.updateVariantLabel = function(e, select) {
      ...
      renderedLabel = "<strong>" + label.replace('Term','Weeks') + ":</strong>";
      return select.prev(".select-text").html(renderedLabel + " " + selectedVariant.replace('weeks',''));
    };
...
(function() {
  ...
  window.SlideshowView = (function(superClass) {
    ...
    SlideshowView.prototype.setupSlides = function() {
      ...
      this.$('.home-slide:first').addClass('active');
      if (this.ltIE9) {
    ...
    SlideshowView.prototype.updateSlidePagination = function(theSlideshow, currSlideID) {
      this.slidePagination.find('.active').removeClass('active');
      
      console.log(theSlideshow + " is slideshow");
      console.log(currSlideID + " is index");
      console.log($('.' + theSlideshow + '-pagination').find('span[data-slide-id="'+currSlideID+'"]'));
      
      return $('.' + theSlideshow + '-pagination').find('span[data-slide-id="'+currSlideID+'"]').addClass('active');
    };
 
   SlideshowView.prototype.updateSlideContent = function(e) {
      console.log("UPDATE");
      
      $(".slide-twitter").each(function(index) {
        console.log(index);
        if(index > -1){
          var currentTweet = $(this).attr("id");
          tweetUrl = $(this).attr("data-tweet-url");
    ...
    SlideshowView.prototype.previousSlide = function(e) {
      var theSlideshow, currSlideID;
      if (this.sliding) {
        return;
      }
      theSlideshow = $(e.currentTarget).parent().find(".home-slideshow").attr('id');
      
      $('#' + theSlideshow).find('.home-slide').first().parent().prepend($('#' + theSlideshow).find('.home-slide').last());
   	  //$('.' + theSlideshow + '-pagination').find('span').parent().prepend($('.' + theSlideshow + '-pagination').find('span').last());

      //this.updateSlideContent();
      
      currSlideID = $('#' + theSlideshow).find('.home-slide').first().attr("id");      
      
      //var slideCount = $('#' + theSlideshow).find('.home-slide').length;
      
      //var slideshowWidth = $('#' + theSlideshow).width();
      //var slideDistanceLeft = slideshowWidth / 3;
      //currSlideID.css("left",); 	
      
 //     currSlide.removeClass("home-slide-c-1");
 	//  currSlide.addClass("home-slide-c-2");
     ...
     /*   
        if(i==slideCount){
          ...
          console.log("last item = .home-slide-c-"+i);
          
		  var totalOfClass = $("."+"home-slide-c-"+i).length;
          
          console.log("total of class = " + totalOfClass);
          
          $("."+"home-slide-c-"+i).each(function(index) {
              //if (index === totalOfClass - 1) {
            if(!$(this).next().hasClass("home-slide-c-" + (slideCount)) || $(this).next().length==0){
          		console.log($(this));
                $(this).removeClass("home-slide-c-"+i).addClass("home-slide-c-1");    
            }
            //$(this).removeClass("home-slide-c-"+i).addClass("home-slide-c-" + (i+1));
          ...
          /* $("."+"home-slide-c-"+i).each(function(index) {
              ...
              if (index === totalOfClass - 1) {
          		  console.log($(this));
                  if(i==7){
                    console.log("SLIDE 7.2"); 
                    console.log("home-slide-c-"+i+"to home-slide-c-" + (i+1));
                  }
                  $(this).removeClass("home-slide-c-"+i).addClass("home-slide-c-" + (i+1));
              }
          }); 
          ...
          $("."+"home-slide-c-"+i).each(function(index) {
              ...
              console.log("next" + $(this).next().length);
                 console.log("SLIDE 7 ---" + i + "--- " + $(this).next().hasClass("home-slide-c-1"));
              if(i==7 && $(this).next().hasClass("home-slide-c-1")){
                 console.log("SLIDE 7.2"); 
                 console.log("home-slide-c-"+i+"to home-slide-c-" + (i+1));
	             $(this).removeClass("home-slide-c-"+i).addClass("home-slide-c-" + (slideCount));
              }else if($(this).next().hasClass("home-slide-c-" + (i+1)) || $(this).next().length==0){
                if(i==7){
                console.log("seven - want make 8 ....i="+i);
                }
	             $(this).removeClass("home-slide-c-"+i).addClass("home-slide-c-" + (i+1));
              }
          }); */
      ...
      /* NEXT
      currSlide.removeClass("home-slide-c-1");
 	  currSlide.addClass("home-slide-c-" + slideCount);
      */
      
      this.updateSlidePagination(theSlideshow, currSlideID);
      
      //this.showNewSlide('prev','',theSlideshow);
      return e.preventDefault();
    };

    SlideshowView.prototype.nextSlide = function(e) {
      var theSlideshow, currSlideID, tweetUrl;
      if (this.sliding) {
        return;
      }
      ...
      $('#' + theSlideshow).find('.home-slide').parent().append($('#' + theSlideshow).find('.home-slide').first());
	  //$('.' + theSlideshow + '-pagination').find('.pagination-slide').parent().append($('.' + theSlideshow + '-pagination').find('span').first());
 
      this.updateSlideContent();
           
      currSlideID = $('#' + theSlideshow).find('.home-slide').first().attr("id");
      console.log(currSlideID + " is current slide");
      
      this.updateSlidePagination(theSlideshow, currSlideID);
      
      // this.showNewSlide('next','',theSlideshow);
      if (e) {
        return e.preventDefault();
      } 
    };
    ...
    SlideshowView.prototype.specificSlide = function(e) {
      var nextSlideID, theSlideshow, currSlideID;
      theSlideshow = $(e.currentTarget).parent().parent().find(".home-slideshow").attr('id');
      nextSlideID = $(e.currentTarget).data('slide-id');
      
      currSlideID = $('#' + theSlideshow).find('.home-slide').first().attr('id');
      while(currSlideID != nextSlideID){
		$('#' + theSlideshow).find('.home-slide').parent().append($('#' + theSlideshow).find('.home-slide').first());
		currSlideID = $('#' + theSlideshow).find('.home-slide').first().attr('id');
      ...
      if (!$(e.currentTarget).hasClass('active')) {
        ...
        console.log("NSID" + nextSlideID);
        
        return this.showNewSlide('next', nextSlideID, theSlideshow);
      }*/
      if (e) {
        return e.preventDefault();
      }
    ...
    SlideshowView.prototype.showNewSlide = function(type, specificSlide,theSlideshow) {
      console.log("theSlideshow to edit: "+theSlideshow);
      var currSlidesName, activeSlide, called, direction, fallback, imageHeight, nextSlide, slideHeight, slideID, windowWidth;
      this.sliding = true;
      called = false;
      currSlidesName = '#' + theSlideshow + ' .home-slide';
      console.log(currSlidesName);
      this.slides = this.$(currSlidesName);
      ...
      activeSlide = this.$('#'+theSlideshow).find('.active');
  ...
  window.CartView = (function(superClass) {
    ...
    CartView.prototype.updateQuantity = function(e) {
      ...
      /***
        added
      */
      oldQuantity = parseInt(productQuantity.data('val'), 10);
      
      if($(e.target).hasClass('cart-item-quantity-display')){
        newQuantity = parseInt(productQuantity.val(), 10);
      }
      /***
        end addition
      */
      ...
      /***
        added
      */
      productQuantity.data('val',newQuantity);
      /***
        end addition
      */
      if (newQuantity === 0) {
          ...
          return function(cart) {
            ...
            for (i = 0, len = ref.length; i < len; i++) {
              ...
              if (item.id === variant) {
                ...
                if(!productRow.find('.cart-item-quantity-display').hasClass('is-booklet')){
                  if(productRow.find('.cart-item-product-wrap').hasClass('subscription-item')){
                    inspira.check_booklets._init(productRow.find('.cart-item-quantity-display').val(),oldQuantity);
                  }
                }
              }
            }
    ...
    CartView.prototype.removeProduct = function(e, variant) {
      ...
      swapProductText = function() {
        ...
        if(!itemRow.find('.cart-item-quantity-display').hasClass('is-booklet')){
          inspira.check_booklets._init(0,itemRow.find('.cart-item-quantity-display').data('val'));
        }
        itemRow.fadeOut(function(){
          $(this).remove();
          setTimeout(function(){
            if($('.template-cart .cart-item-product .subscription-item').length == 0){
              $('.template-cart p.subscription-message,.template-cart .recurring-list').fadeOut();
            }
          },500);
        });
